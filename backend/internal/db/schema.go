		...
		Schema: bson.M{
			"$jsonSchema": bson.M{
				...
				"properties": bson.M{
					...
					"supplierId":     bson.M{"bsonType": "objectId"},
					"priceGroupName": bson.M{"bsonType": "string", "maxLength": 100},
					"notes":          bson.M{"bsonType": "string", "maxLength": 500},
					"orderId":        bson.M{"bsonType": "objectId"},
					"freightIndex":   bson.M{"bsonType": "int"},
					"quantity":       bson.M{"bsonType": "int", "minimum": 0},
					"source":         bson.M{"bsonType": "string", "enum": bson.A{"order", "import", "manual"}},
					"createdAt":      bson.M{"bsonType": "date"},
					"updatedAt":      bson.M{"bsonType": "date"},
				},
			},
...
func inventoryLotsSchema() CollectionSchema {
	return CollectionSchema{
		Collection: "inventory_lots",
		Schema: bson.M{
			"$jsonSchema": bson.M{
				"bsonType": "object",
				"required": bson.A{"tenantId", "productId", "receivedAt", "quantity", "remaining", "unitEkEur", "source", "createdAt", "updatedAt"},
				"properties": bson.M{
					"tenantId":     bson.M{"bsonType": "objectId"},
					"productId":    bson.M{"bsonType": "objectId"},
					"orderId":      bson.M{"bsonType": "objectId"},
					"freightIndex": bson.M{"bsonType": "int"},
					"receivedAt":   bson.M{"bsonType": "date"},
		...
		Schema: bson.M{
			"$jsonSchema": bson.M{
				...
				"properties": bson.M{
					...
					"userDef01":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef02":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef03":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef04":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef05":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef06":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef07":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef08":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef09":      bson.M{"bsonType": "string", "maxLength": 255},
					"userDef10":      bson.M{"bsonType": "string", "maxLength": 255},
					"createdAt":      bson.M{"bsonType": "date"},
					"updatedAt":      bson.M{"bsonType": "date"},
				},
			},
			...
			"$jsonSchema": bson.M{
				...
				"properties": bson.M{
					...
					"address": bson.M{
						"bsonType": "object",
						"properties": bson.M{
							"street":  bson.M{"bsonType": "string", "maxLength": 200},
							"city":    bson.M{"bsonType": "string", "maxLength": 100},
							"zip":     bson.M{"bsonType": "string", "maxLength": 20},
							"country": bson.M{"bsonType": "string", "maxLength": 100},
						},
					},
					"active":    bson.M{"bsonType": "bool"},
					"createdAt": bson.M{"bsonType": "date"},
