...
export default function HarboursPage() {
  ...
  useHighlightRow(harbours.length > 0);
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-dark-800/50">
              {harbours.length === 0 ? (
                ...
                <tr key={h.id} data-highlight-id={h.id} className="hover:bg-dark-800/30">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button onClick={() => { window.scrollTo({ top: 0, behavior: 'smooth' }); setEditing(h); setForm({ name: h.name, description: h.description }); setShowForm(false); }}
